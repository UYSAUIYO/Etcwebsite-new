      ...
      <v-tabs vertical :dark="dark">
        ...
        <v-tab-item>
          <v-card flat :dark="dark">
            ...
            <v-card-text>
              <v-card-actions>以下是参与服务器审核流程的一些要求和注意事项：</v-card-actions>
              <p>
                1.请确保您提供的联系方式是正确的，并且可以联系到您本人的账号。
              </p>
              <p>
                2.审核玩家需要通过唯一渠道进行审核。您需要注册一个<a
                  @click="regsiter"
                  >审核平台账号</a
                >并填写一审问卷。一审问卷内容可能会根据实际情况进行修改，以确保问卷没有问题。
              </p>
              <p>
                3.审核玩家请认真填写一审问卷,重复提交问卷会降低印象分，如果提交问卷在一个月内没有得到答复，则是未通过。
              </p>
              <p>
                4.请认真填写一审问卷，重复提交问卷会降低您的印象分。如果您提交的问卷在一个月内没有得到答复，则说明您未通过审核。
              </p>
              <p>
                5.如果您的一审问卷通过审核，您将进入二审阶段。二审通过后，您将有为期一周的<a plain @click="tftip">考察期</a>，主要考察您的在线率和交流情况。
              </p>
              <p>
                6.如果您有更多的特长，这可能是个加分项。请在个人情况简介中好好写下您的相关经验和技能，我们会更加在意。
              </p>
              <p>7.如果您通过了审核并成功入服，我们会提供<a @click="note">入服须知</a>,请认真阅读。</p>
