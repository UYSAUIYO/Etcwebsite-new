<template>
    <v-card class="pt-4 mb-4" :dark="dark" elevation="1" style="background: none">
        <v-list-item>
            <v-list-item-content>
                <v-list-item-title class="headline">联系我们</v-list-item-title>
...
<script>
import botsetps from "@/data/botsetps.json";
